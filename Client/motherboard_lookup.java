...
public class motherboard_lookup extends javax.swing.JFrame {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
        if (this.pc.compareTo("") == 0 || this.pc.compareTo("No PC's Created.") == 0) {
            ...
            String[] row = new String[this.motherboardTable.getColumnCount()];

            for (int x = 0; x < this.motherboardTable.getColumnCount(); x++) {
                row[x] = "" + this.motherboardTable.getModel().getValueAt(this.motherboardTable.getSelectedRow(), x);
            }
            ...
            try {
                URL url = new URL("http://localhost:8080/addMotherboard");
