...
public class storage_lookup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Storage Parts");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Storage Parts");
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
        if (this.pc.compareTo("") == 0 || this.pc.compareTo("No PC's Created.") == 0) {
            ...
            String[] row = new String[this.storageTable.getColumnCount()];

            for (int x = 0; x < this.storageTable.getColumnCount(); x++) {
                row[x] = "" + this.storageTable.getModel().getValueAt(this.storageTable.getSelectedRow(), x);
            }
            ...
            try {
                URL url = new URL("http://localhost:8080/addStorage");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(storage_lookup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new storage_lookup().setVisible(true);
            }
        });
    }
