...
public class psu_lookup extends javax.swing.JFrame {
    ...
    public psu_lookup(String[][] names, String pc) {
        this.names = names;
        this.pc = pc;
        initComponents();
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
        if (this.pc.compareTo("") == 0 || this.pc.compareTo("No PC's Created.") == 0) {
            ...
            String[] row = new String[this.psuTable.getColumnCount()];

            for (int x = 0; x < this.psuTable.getColumnCount(); x++) {
                row[x] = "" + this.psuTable.getModel().getValueAt(this.psuTable.getSelectedRow(), x);
            }
            ...
            try {
                URL url = new URL("http://localhost:8080/addPSU");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(psu_lookup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new psu_lookup().setVisible(true);
            }
        });
    }
